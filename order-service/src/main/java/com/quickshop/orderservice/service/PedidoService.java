...
import com.quickshop.orderservice.event.EventoPedidoRealizado;
...
public class PedidoService {
    ...
    private final KafkaTemplate<String, EventoPedidoRealizado> template;
    ...
    public void savePedido(PedidoRequest request) throws IllegalArgumentException {
        ...
        Boolean result = webClientBuilder.build().put()
                ...
                .block();
        if (result)  {
            template.send("notificacao", new EventoPedidoRealizado(pedido.getCodigo()));
